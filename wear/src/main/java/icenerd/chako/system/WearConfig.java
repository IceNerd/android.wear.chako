...
public final class WearConfig {
    ...
    public static void overwriteKeysInConfigDataMap( final GoogleApiClient googleApiClient, final DataMap configKeysToOverwrite ) {
        ...
        WearConfig.fetchConfigDataMap(googleApiClient,
                new FetchConfigDataMapCallback() {
                    ...
                    public void onConfigDataMapFetched(DataMap currentConfig) {
                        ...
                        WearConfig.putConfigDataItem(googleApiClient, overwrittenConfig);
                    }
                }
        );
        ...
        Wearable.DataApi.putDataItem(googleApiClient, putDataMapRequest.asPutDataRequest())
                .setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
                    ...
                    public void onResult(DataApi.DataItemResult dataItemResult) {
                        if( BuildConfig.DEBUG ) Log.d("WearConfig", "putDataItem result status: " + dataItemResult.getStatus());
                    }
                });
    }
